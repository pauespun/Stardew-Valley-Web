const btnPescarMuntanya = document.getElementById('btn-pescar-muntanya');
...
const llistaPeixos = ["Truita", "Carpa", "Lluc", "Silur", "Branca", "Ulleres trencades"];
const llistaQualitats = ["Normal", "Plata", "Or"];

btnPescarMuntanya.addEventListener('click', obrirMinijoc);
